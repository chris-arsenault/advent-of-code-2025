...
- **Haskell internal (9.8x):** Geometric computations with strict evaluation work reasonably well in Haskell.
...
- **Haskell is reasonable (9.8x):** With proper strict evaluation, Haskell handles geometric computations well.
